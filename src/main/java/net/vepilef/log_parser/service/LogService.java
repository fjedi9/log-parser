package net.vepilef.log_parser.service;
...
import net.vepilef.log_parser.repository.CommentLogRepository;
import net.vepilef.log_parser.repository.LogRepository;
...
public class LogService {
	...
	public List<Log> getLogFromFile(Object accessLog) {
